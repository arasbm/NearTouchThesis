\newcommand\thesistitle{Near Touch Interactions: Understanding Grab and Release Actions}
% One needs to make adjustments for a Master's Thesis
\newcommand\nameanddegrees{
Aras Balali Moghaddam\\
B.Sc., Thompson Rivers University, 2009}
\newcommand\panel{
\HRule\\\panelist{Dr. Melanie Tory}{Co-Supervisor}{Department of Computer Science}
\HRule\\\panelist{Dr. Colin Swindells}{Co-Supervisor}{Department of Computer Science}
}
...
\TOCadd{Contents}\tableofcontents
